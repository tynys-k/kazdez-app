...
const ADMIN_TAB_ORDER = ["today", "jobs", "schedule", "routes", "tasks", "leads", "retention", "subscriptions", "repeats", "finance", "analytics", "growth", "opex", "cash", "done", "canceled", "team", "payroll", "partners", "stock", "tenders", "docs", "materials", "knowledge", "journal", "trash"];
...
const ROLE_DEFAULT_PERMISSIONS = {
  ...
  marketer: ["tab.today", "tab.leads", "action.leads_edit", "tab.retention", "tab.analytics", "tab.growth", "tab.materials", "tab.knowledge", "tab.tasks"],
