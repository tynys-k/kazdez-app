...
const ROLE_DEFAULT_PERMISSIONS = {
  ...
  manager: ["tab.today", "tab.jobs", "tab.schedule", "tab.done", "tab.canceled", "tab.routes", "tab.tasks", "action.tasks_manage", "action.jobs_edit", "tab.leads", "tab.clients", "action.leads_edit", "tab.repeats", "tab.retention", "tab.subscriptions", "tab.partners", "action.partners_edit", "tab.materials", "tab.knowledge"],
  marketer: ["tab.today", "tab.leads", "tab.clients", "action.leads_edit", "tab.retention", "tab.analytics", "tab.growth", "tab.materials", "tab.knowledge", "tab.tasks"],
